...
*    1. Configure the incoming routes
*    2. Add a Request Handler
*  Demonstrate how to pass in custom routing rules
*/

var msgProperties = {
    "serviceName" : "urn:nhs-itk:services:201005:SendDocument-v1-0",
    "replyTo": "http://localhost:3001/asyncreply/clinicaldocuments",
    "key": "../certs-client/client.pem", // should load from certificate storeb using the friendlyName
    ...
    "url": "http://localhost:3000/async/clinicaldocuments",
