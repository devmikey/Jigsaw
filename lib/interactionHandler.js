...
var syncHttpResponse = function(req, res, err, callback) {
    ...
    try {
        if(err != undefined) {
            logger.log("ITK 4.2.3 - Asynchronous Failure Scenario 2 ");
            ...
            res.end();
              ...
              logger.log("ITK 4.2.1 Asynchronous Success Scenario");
...
exports.create = function(service, description, route, pattern, custommiddleware, process) {
    return {
		"service": service,
