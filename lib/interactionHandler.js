...
var soapmsg = require('../client/messages/soapEnvelope');
...
var syncHttpResponse = function(req, res, err) {
    ...
    if(err != undefined) {
        ...
        msg = soapmsg.getMessage(header, soapmsg.itkError(err));
        res.writeHead(500);
        res.write(msg);
        res.end();
    }
...
var simpleSyncResponse = function(req, res,  err) {
    ...
    if(err != undefined) {
        ...
        msg = soapmsg.getMessage(header, soapmsg.simpleMessageResponse());
...
var syncResponse = function(req, res, err) {
    ...
    if(err != undefined) {
        ...
        msg = soapmsg.getMessage(header, soapmsg.syncResponse());
        res.writeHead(200, { 'Content-Type': 'text/xml' });
        res.write(msg);
        res.end();
    }
