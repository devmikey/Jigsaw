...
// the async response needs to be pushed out to the replyTo address
var asyncResponse = function(req, res, result, err) {
    ...
    var msg = messageResponses.getEnvelope(header, messageResponses.asyncResponse(result));
    client.send(msg);

};

var simpleSyncResponse = function(req, res, result,  err) {
    var app = req.app;
    var jrequest = app.body.json;
    ...
    if(err != undefined) {
        ...
        msg = messageResponses.getEnvelope(header, messageResponses.simpleMessageResponse());
...
var syncResponse = function(req, res, result, err) {
    ...
    if(err != undefined) {
        ...
        msg = messageResponses.getEnvelope(header, messageResponses.syncResponse(result));
